...
const TableAction = ({ thead__count, tbody__count }) => {
  var head = ["Company", "Country", "Contact", "Edit", "Delete"];
  var data = [
    {
      userId: 1,
      id: 1,
        ...
        {data?.map((e, i) => (
          <tr>
            ...
            <td class="border px-8 py-4">
              <Button disabled={false} text="edit" />
            </td>
            <td class="border px-8 py-4">
              <Button
                disabled={false}
                text="delete"
                className="bg-red-600 text-white border-red-700 hover:bg-red-800"
              />
            </td>
          </tr>
        ))}
